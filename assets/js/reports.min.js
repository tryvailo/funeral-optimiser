...
class ReportsModule {
        ...
        const recommendations = {
            'traditional': [
                ...
                },
                {
                    ...
                    text: 'Some providers offer discounts for off-peak scheduling or weekday services.'
                },
                {
                    icon: '📋',
            ...
            'direct': [
                ...
                },
                {
                    icon: '⏰',
                    title: 'Consider Timing',
                    text: 'Weekday services are often cheaper than weekends.'
                }
            ],
            'hybrid': [
                {
    ...
    updateChecklistProgress(checkbox) {
        ...
        if (savingsTracker) {
            savingsTracker.textContent = `Potential savings unlocked: £${totalSavings.toLocaleString()}`;
        }
